...
9) Register the ViewHandler, Lang, PermissionManager and the SessionHandler to your application in your application's
init() method.
```
@Override
public void init() {
...
```
10) Modify your web.xml file to register the ContextListener and to add the i18n servlet
```
<listener>
  <listener-class>
